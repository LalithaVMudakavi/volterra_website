...
//     icon: Hotel,
//      image: "/images/industries/destinationcharging.png",
//     description:
...
//     title: "Highways",
//     icon: Zap,
//      image: "/images/industries/highway.png",
//     description:
...
//     icon: Truck,
//       image: "/images/industries/fleetlogistics.png",
//     description:
...
//     icon: Landmark,
//        image: "/images/industries/publicinfrastructure.png",
//     description:
...
export default function Industries() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-375 px-4 sm:px-6 lg:px-12">
        ...
        <div className="-mt-2 grid gap-8 sm:gap-12 lg:-mt-6 lg:gap-16 lg:grid-cols-[340px_1fr]">
  ...
  <div className="space-y-3 sm:space-y-4">
    ...
    {industries.map((industry, index) => (
      ...
      >
        ...
        <div className="flex min-h-14 items-center justify-between px-4 py-3 sm:px-6">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: .45 }}
            className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,.06)] lg:rounded-[36px]"
          >

            {/* Hero */}

           <div className="relative min-h-[360px] overflow-hidden sm:min-h-[400px] lg:min-h-105">
  ...
  {/* Content */}
  <div className="relative z-10 flex min-h-[360px] flex-col justify-center p-6 sm:min-h-[400px] sm:p-8 lg:min-h-105 lg:p-12">
  ...
  <div className="absolute right-6 bottom-4 hidden lg:block">
    ...
    >
      {String(active + 1).padStart(2, "0")}
            ...
            <div className="grid gap-8 p-5 sm:gap-10 sm:p-8 lg:gap-12 lg:p-12 lg:grid-cols-[1fr_280px]">
              ...
              <div>
                ...
                <div className="mt-8 grid gap-4 sm:mt-10 sm:gap-5 md:grid-cols-2 lg:mt-12">
              ...
              <div className="rounded-3xl bg-linear-to-br from-lime-500 to-green-600 p-6 text-white sm:p-8 lg:rounded-[30px]">
